...
notes\footnote{\href{https://github.com/arfc/saltproc/releases}} contain more
...
all functions; separation processes applied to  used an implicit 100\%
efficiency \cite{rykhlevskii_advanced_2018}. The structure of \SaltProc v0.1 did
not lend itself easily to development of more sophisticated treatments of
